...
.controller('nomeDaComidaCtrl', ['$scope', '$stateParams', // The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
// You can include any angular dependencies as parameters for this function
// TIP: Access Route Parameters for your page via $stateParams.parameterName
function ($scope, $stateParams) {
...
.controller('nomeDoRestauranteCtrl',function ($scope, $http, $stateParams) {
    $scope.result = "";
    $http.get('http://127.0.0.1:8000/tgAPI1/default/api/produto.json')
    .success(function(data, status, headers,config){
//      console.log('data success');
      console.log(JSON.stringify(data)); // for browser console
      $scope.result = data.content; // for UI
    })
